...
module.exports = function(creep) {
	...
	var spawn = creep.pos.findClosestByPath(Game.MY_SPAWNS);
	var target = creep.pos.findClosestByPath(Game.CREEPS, {filter: function(object) {return object.hits < object.hitsMax;}});
	var range = 5;
